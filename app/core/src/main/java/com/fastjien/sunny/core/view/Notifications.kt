...
import com.fastjien.sunny.core.ktx.getBitmap
import com.fastjien.sunny.core.ktx.selfLaunchIntent
...
object Notifications {
        ...
        AppContext.apply {
            ...
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                Notification.Builder(this, UPDATED_CHANNEL)
                    .setSmallIcon(getBitmap(R.drawable.ic_sunny_outline).toIcon())
            } else {
                Notification.Builder(this).setPriority(Notification.PRIORITY_HIGH)
                    .setSmallIcon(R.drawable.ic_sunny_outline)
            }
    ...
    fun updateAvailable() {
        AppContext.apply {
            ...
            val bitmap = getBitmap(R.drawable.ic_sunny_outline)
            val builder = if (SDK_INT >= Build.VERSION_CODES.O) {
                ...
                .setLargeIcon(bitmap)
                .setContentTitle(getString(R.string.sunny_update_title))
