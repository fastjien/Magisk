...
import com.fastjien.sunny.core.base.BaseJobService
import com.fastjien.sunny.core.di.ServiceLocator
import com.fastjien.sunny.core.download.DownloadEngine
import com.fastjien.sunny.core.download.DownloadSession
...
class JobService : BaseJobService() {
    ...
    private fun downloadFile(params: JobParameters): Boolean {
        ...
        val subject = params.transientExtras
            .getParcelable(DownloadEngine.SUBJECT_KEY, Subject::class.java) ?: return false
