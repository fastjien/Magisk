...
class ShellInit : Shell.Initializer() {
    override fun onInit(context: Context, shell: Shell): Boolean {
        ...
        shell.newJob().apply {
            ...
            if (shell.isRoot) {
                add("export SUNNYTMP=\$(sunny --path)")
            ...
            if (Info.noDataExec) {
                ...
                add(
                    "if [ -x \$SUNNYTMP/.sunny/busybox/busybox ]; then",
                    "  cp -af $localBB \$SUNNYTMP/.sunny/busybox/busybox",
                    "  exec \$SUNNYTMP/.sunny/busybox/busybox sh",
                    "else",
