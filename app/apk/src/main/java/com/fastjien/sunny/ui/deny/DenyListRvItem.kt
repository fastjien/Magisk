package com.fastjien.sunny.ui.deny
...
import com.fastjien.sunny.databinding.addOnPropertyChangedCallback
    ...
    var state: Boolean?
        ...
        set(value) = set(value, _state, { _state = it }, BR.state) {
            if (value == true) {
                ...
                Shell.cmd("sunny --denylist rm ${info.packageName}").submit()
...
class ProcessRvItem(
    ...
    var isEnabled
        ...
        set(value) = set(value, process.isEnabled, { process.isEnabled = it }, BR.enabled) {
            ...
            Shell.cmd("sunny --denylist $arg $pkg \'$name\'").submit()
        }
