package com.fastjien.sunny;

import static android.R.string.no;
import static android.R.string.ok;
import static android.R.string.yes;
import static com.fastjien.sunny.R.string.dling;
import static com.fastjien.sunny.R.string.no_internet_msg;
import static com.fastjien.sunny.R.string.upgrade_msg;
...
import com.fastjien.sunny.net.Networking;
import com.fastjien.sunny.net.Request;
import com.fastjien.sunny.utils.APKInstall;
...
public class DownloadActivity extends Activity {
    ...
    private static final String APP_NAME = "Sunny";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Networking.checkNetworkStatus(this)) {
            ...
            new AlertDialog.Builder(themed).setCancelable(false).setTitle(APP_NAME).setMessage(getString(no_internet_msg)).setNegativeButton(ok, (d, w) -> finish()).show();
        }
    }
    ...
    private void showDialog() {
        new AlertDialog.Builder(themed).setCancelable(false).setTitle(APP_NAME).setMessage(getString(upgrade_msg)).setPositiveButton(yes, (d, w) -> dlAPK()).setNegativeButton(no, (d, w) -> finish()).show();
    }
    ...
    private void decryptResources(OutputStream out) throws Exception {
        ...
        SecretKey key = new SecretKeySpec(com.fastjien.sunny.Bytes.key(), "AES");
        IvParameterSpec iv = new IvParameterSpec(com.fastjien.sunny.Bytes.iv());
        cipher.init(Cipher.DECRYPT_MODE, key, iv);
        var is = new InflaterInputStream(new CipherInputStream(new ByteArrayInputStream(com.fastjien.sunny.Bytes.res()), cipher));
        try (is; out) {
