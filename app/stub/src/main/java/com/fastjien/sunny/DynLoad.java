...
import static com.fastjien.sunny.BuildConfig.APPLICATION_ID;
...
import com.fastjien.sunny.utils.DynamicClassLoader;
...
public class DynLoad {
    ...
    static DynamicClassLoader loadApk(Context context) {
        ...
        if (BuildConfig.DEBUG) {
            try {
                File external = new File(context.getExternalFilesDir(null), "sunny.apk");
                if (external.exists()) {
                    apk.delete();
                    try {
